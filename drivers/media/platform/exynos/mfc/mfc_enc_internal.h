...
struct mfc_fmt enc_formats[] = {
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit Compress single (SBWC)",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit Compress single (SBWC)",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit Compress Lossy (SBWCL)",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit Compress Lossy (SBWCL)",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit Compress Lossy single (SBWCL)",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit Compress Lossy single (SBWCL)",

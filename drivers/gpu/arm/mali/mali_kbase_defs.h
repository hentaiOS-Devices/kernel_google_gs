...
/* mmu */
#define VALHALL_MMU_LEVEL(x) (x)

#define VALHALL_MMU_TOPLEVEL    VALHALL_MMU_LEVEL(0)

#define VALHALL_MMU_BOTTOMLEVEL VALHALL_MMU_LEVEL(3)
...
struct kbase_mmu_table {
	u64 *mmu_teardown_pages[VALHALL_MMU_BOTTOMLEVEL];
...
#endif /* CONFIG_MALI_VALHALL_CINSTR_GWT */

...
int kbase_hwaccess_pm_init(struct kbase_device *kbdev)
{
	...
	if (!IS_ENABLED(CONFIG_MALI_VALHALL_HW_ERRATA_1485982_USE_CLOCK_ALTERNATIVE)) {
		kbdev->pm.backend.gpu_clock_slow_down_wa = false;
...
{
#if defined(CONFIG_MALI_VALHALL_DVFS)
...
#elif defined(CONFIG_MALI_VALHALL_DVFS) /* CONFIG_MALI_VALHALL_DEVFREQ */
